//
//  BassStandardTuningViewController.swift
//  MusicTheory
//
...
class BassStandardTuningViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        contentImage.image = UIImage(named: "bass_standard")
    }
